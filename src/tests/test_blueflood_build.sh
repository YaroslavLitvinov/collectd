...
gcc -o $CURDIR/test_blueflood1 ./src/tests/test_blueflood1.o ./src/tests/mock/plugin.o ./src/tests/test_blueflood_mock.o -lpthread $GCOV_LDFLAGS
...
gcc -c ./src/tests/test_blueflood_mock.c -o ./src/tests/test_blueflood_mock.o $CFLAGS
gcc -o $CURDIR/test_blueflood2 ./src/tests/test_blueflood2.o ./src/tests/mock/plugin.o ./src/tests/test_blueflood_mock.o -lpthread $GCOV_LDFLAGS
#check compilation error
if [ $? -ne 0 ]; then
    exit
fi
